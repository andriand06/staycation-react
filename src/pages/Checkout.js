...
import Stepper, {Numbering, Meta, MainContent, Controller } from 'components/Stepper'
    ...
    render() {
        ...
        const steps = {
            bookingInformation : {
                ...
                content: (
                    <BookingInformation data={data} itemDetails={itemDetails} checkout={checkout} onChange={this.onChange} />
                ),
            },
            payment : {
                title:"Payment",
                                ...
                                {currentStep === "bookingInformation" && (
                                    <Controller>
                                        {data.firstName !== "" &&
                                         ...
                                         <Button type="link" className="btn" isLight isBlock  href={`/properties/${itemDetails._id}`}>
                                             Cancel
                                         </Button>
                                    </Controller>
                                )}
